/*
 * NFS Underground 2 - Keyboard Double Steering ASI Plugin (v3 - fixed)
 *
 * Build (mingw-w64, 32-bit):
 *   i686-w64-mingw32-gcc -shared -o nfs_ds.asi doublesteer_u2.c
...
/* ═══════════════════════════════════════════════════════════════
 * Game addresses (NFSU2 speed2.exe v1.2)
 *
...
/* ═══════════════════════════════════════════════════════════════
 * INI loader — looks for nfs_ds.ini next to speed2.exe
 * ═══════════════════════════════════════════════════════════════ */
